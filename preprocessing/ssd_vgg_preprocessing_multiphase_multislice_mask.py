...
def preprocess_for_eval_multiphase_multislice_mask(nc_image, art_image, pv_image, mask_image, labels, bboxes, xs, ys,
                        out_shape, data_format='NHWC',
    ...
    with tf.name_scope(scope):
        ...
        if do_resize:
            if resize == Resize.NONE:
                ...
                pv_image = tf_image_multiphase_multislice_mask.resize_image(pv_image, out_shape,
                                                                            method=tf.image.ResizeMethod.BILINEAR,
                                                                            align_corners=False)
                mask_image = tf_image_multiphase_multislice_mask.resize_image(mask_image, out_shape,
                                                                              method=tf.image.ResizeMethod.NEAREST_NEIGHBOR,
                                                                              align_corners=False)
        ...
        return nc_image, art_image, pv_image, mask_image, labels, bboxes, xs, ys
...
def preprocess_image_multiphase_multislice_mask(nc_image, art_image, pv_image, mask_image,
    ...
    if is_training:
        ...
        return preprocess_for_eval_multiphase_multislice_mask(nc_image, art_image, pv_image, mask_image, labels, bboxes, xs, ys,
                                   out_shape=out_shape,
                                   data_format=data_format,
                                   **kwargs)
